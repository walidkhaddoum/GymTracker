                                                            ...
                                                            <tr class="even:bg-slate-50 dark:even:bg-slate-700">
                                                                ...
                                                                <td class="table-td">
                                                                    @if ($reservation->status === 0)
                                                                        <button
                                                                            onclick="showModal({{ $reservation->id }}, 'accept')"
                                                                            class="btn inline-flex justify-center btn-success rounded-[25px]">
                                                                        ...
                                                                        <button
                                                                            onclick="showModal({{ $reservation->id }}, 'decline')"
...
<script>
    function showModal(reservationId, action) {
        // Display your modal here.
        // When the trainer confirms, call the following function:
        submitForm(reservationId, action);
    }
</script>
<script>
    function submitForm(reservationId, action) {
        var form = document.createElement('form');
        document.body.appendChild(form);
        form.method = 'post';
        form.action = '{{ route('trainer.updateReservation') }}';
