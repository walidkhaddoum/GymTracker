                            ...
                            <div class=" space-y-5">
                                ...
                                <div class="card">
                                    <header class=" card-header noborder">
                                        <h4 class="card-title">Gyms Lists </h4>
                                        <a href="{{ route('admin.gyms.create') }}" class="btn inline-flex justify-center btn-outline-dark capitalize">Add Gym</a>
                                            ...
                                            <div class="inline-block min-w-full align-middle">
                                                <div class="overflow-hidden ">
                                                    <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700" id="data-table">
                                                        ...
                                                        @foreach($gyms as $gym)
                                                            <tr>
                                                                <td  class="table-td">{{ $gym->name }}</td>
                                                                <td  class="table-td">{{ $gym->address }}</td>
                                                                <td class="table-td">
                                                                    <form method="POST" action="{{ route('admin.gyms.destroy', $gym->id) }}">
                                                                        @csrf
                                                                        @method('DELETE')
