...
<head>
    ...
    <title>Gym Tracker - Specializations Lists</title>
                            ...
                            <div class=" space-y-5">
                                ...
                                <div class="card">
                                    <header class=" card-header noborder">
                                        <h4 class="card-title">Specializations Lists </h4>
                                        <button data-bs-toggle="modal" data-bs-target="#basic_modal" class="btn inline-flex justify-center btn-outline-dark capitalize">Add Specialization</button>
                                    </header>
                                                ...
                                                <div class="overflow-hidden ">
                                                    <table
                                                        ...
                                                        @foreach($specializations as $specialization)
                                                            <tr>
                                                                <td class="table-td">{{ $specialization->name }}</td>
                                                                <td class="table-td">
                                                                    <a href="{{ route('admin.specializations.edit', $specialization->id) }}">Edit</a>
                                                                    <form method="POST" action="{{ route('admin.specializations.destroy', $specialization->id) }}">
                                                                        @csrf
                                                                        @method('DELETE')
