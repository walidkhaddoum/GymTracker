                                                ...
                                                <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
                                                    ...
                                                    @foreach($user->subscriptions as $subscription)
                                                        <tr class="hover:bg-slate-200 dark:hover:bg-slate-700">
                                                            <td class="table-td">{{ $subscription->start_date }}</td>
                                                            <td  class="table-td">{{ $subscription->start_date }}</td>
                                                            <td  class="table-td">{{ $subscription->end_date }}</td>
                                                            <td  class="table-td">
                                                                @if(Carbon\Carbon::now()->between(Carbon\Carbon::parse($subscription->start_date), Carbon\Carbon::parse($subscription->end_date)))
