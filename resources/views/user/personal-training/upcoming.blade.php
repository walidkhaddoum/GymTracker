                            ...
                            <div class="space-y-8">
                                <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class=" table-th ">Start Date & Time</th>
                                        <th scope="col" class=" table-th ">End Date & Time</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($upcoming_sessions as $index => $session)
                                        <tr>
                                            <th class="table-td" scope="row">{{ $index + 1 }}</th>
